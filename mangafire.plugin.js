...
const plugin = {
  ...
  async chapters(id) {
    ...
    // Sort to prioritize "Official" releases for identical chapter numbers
    parsedChapters.sort((a, b) => {
      if (a._num !== b._num) return a._num - b._num;
      const aOfficial = String(a.group).toLowerCase() === "official" ? 0 : 1;
      const bOfficial = String(b.group).toLowerCase() === "official" ? 0 : 1;
